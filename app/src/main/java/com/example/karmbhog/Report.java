...
public class Report extends AppCompatActivity {
    ...
    EditText workerMobNo, days, avgWork, extraHours;
    Spinner workerName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //other input fields
        days = findViewById(R.id.daysETxt);
        avgWork = findViewById(R.id.avgWorkPerDayETxt);
        extraHours = findViewById(R.id.extraHoursETxt);
        ...
        cancelBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Report.this, Company_dashboard.class));
                finish();
            }
        });
        ...
        submitBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String daysOfWorkStr = days.getText().toString();
                String avgWorkPerDayStr = avgWork.getText().toString();
                String extraHoursStr = extraHours.getText().toString();

                //match mngr city with company city
                if(isRegisterDetailsFilled(errorTxt, workerNameStr, workerMobNoStr, daysOfWorkStr, avgWorkPerDayStr, extraHoursStr)) {
                    EmployeeReport employeeReport = new EmployeeReport(workerNameStr, workerMobNoStr, daysOfWorkStr, avgWorkPerDayStr, extraHoursStr);
                                ...
                                public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                                    if(queryDocumentSnapshots!=null) {
                                        for(DocumentSnapshot documentSnapshot1: queryDocumentSnapshots) {
                                            ...
                                            setReport(mngrEmail[0], userName, employeeReport);
                                        }
                                    }
                                }
                            });
    ...
    private void setReport(String mngrEmail, String userName, EmployeeReport employeeReport) {
        //set report logic
        colRef_manager.document(mngrEmail)
                .collection(Constants.KEY_KITCHEN_MANAGER_EMPLOYEES_COL)
                .document(userName)
    ...
    private ArrayAdapter<String> setSpinner1(String comCity, String workName) {
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<>(Report.this, android.R.layout.simple_spinner_dropdown_item, arrayList);
    ...
    private Boolean isRegisterDetailsFilled(TextView errorTxt, String workerNameStr, String mobNoStr, String daysStr, String avgWorkStr, String extraHours) {
        if(workerNameStr.isEmpty()) {
            ...
            setErrorTxt(errorTxt, "*Please enter days of work");

            return false;
        }

        else if(avgWorkStr.isEmpty()) {
            setErrorTxt(errorTxt, "*Please enter average work hours per day");
            return false;
        }

        else if(extraHours.isEmpty()) {
            setErrorTxt(errorTxt, "*Please enter extra hours of work");
            return false;
        }
